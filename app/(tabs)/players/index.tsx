...
const PlayersScreen = () => {
  ...
  const [filters, setFilters] = useState<PlayerPositionFilter[]>([
    {
      ...
      value: "Goalkeeper",
      active: false,
      onClick: () => toggleFilter("Goalkeeper"),
    },
    {
      label: "DF",
      value: "Defender",
      active: false,
      onClick: () => toggleFilter("Defender"),
    },
    {
      label: "MF",
      value: "Midfielder",
      active: false,
      onClick: () => toggleFilter("Midfielder"),
    },
    {
      label: "FW",
      value: "Forward",
  ...
  useEffect(() => {
    ...
    const searchedPlayers = lowerCaseSearchString
      ? players.filter((player) =>
          player.name.toLowerCase().includes(lowerCaseSearchString)
        )
      : players;
    ...
    setFilteredPlayers(
      searchedPlayers.filter((player) =>
        filters.find(
          (filter) => filter.active && filter.value === player.position
        )
      )
    );
